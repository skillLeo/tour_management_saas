...
class CommissionChart extends Chart
{
    use HasCategory;
    ...
    public function getOptions(): array
    {
        ...
        return [
            'series' => [
                [
                    'name' => trans('plugins/affiliate-pro::reports.approved_commissions'),
                    'data' => Arr::get($data, 'approved', []),
                ],
                [
                    'name' => trans('plugins/affiliate-pro::reports.pending_commissions'),
    ...
    {
        return trans('plugins/affiliate-pro::reports.commission_chart');
    }
