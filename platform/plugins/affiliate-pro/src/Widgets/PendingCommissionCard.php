...
class PendingCommissionCard extends Card
{
    ...
    public function getViewData(): array
    {
        ...
        return array_merge(parent::getViewData(), [
            'content' => view(
                'plugins/affiliate-pro::reports.widgets.pending-commission-card',
    ...
    {
        return trans('plugins/affiliate-pro::reports.pending_commissions');
    }
}
